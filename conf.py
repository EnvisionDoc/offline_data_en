...
latex_documents = [
    (master_doc, 'EnOSDocumentationCenter.tex', 'EnOS Batch Data Processing Documentation',
...
man_pages = [
    (master_doc, 'enosdocumentationcenter', 'EnOS Batch Data Processing Documentation',
     [author], 1)
]
