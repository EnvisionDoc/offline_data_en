...
project = 'EnOS Offline Data Processing'
copyright = '2018, EnOS'
...
latex_documents = [
    (master_doc, 'EnOSDocumentationCenter.tex', 'EnOS Offline Data Processing Documentation',
...
man_pages = [
    (master_doc, 'enosdocumentationcenter', 'EnOS Offline Data Processing Documentation',
     [author], 1)
]
